...
function revenueMain() {
  ...
  return `${siteHeader()}<main>${pageHero(page)}
    <section class="section"><div class="container"><div class="row g-4 align-items-start"><aside class="col-lg-3 order-lg-2"><div class="sidebar-card department-sidebar" data-aos="fade-left"><h3>Quick Navigation</h3>${["Overview","Functions","Services","Documents","Procedure","Hierarchy","Downloads","FAQ","Contact"].map((item) => `<a href="#${item.toLowerCase()}"><i class="bi bi-arrow-right-circle"></i>${item}</a>`).join("")}</div></aside><div class="col-lg-9 order-lg-1">
      ...
      <section id="hierarchy" class="mb-5"><div class="section-heading text-start"><span class="section-kicker">Hierarchy</span><h2>Department Hierarchy</h2></div><div class="hierarchy-grid">${hierarchy.map((role) => `<article class="hierarchy-card" data-aos="fade-up"><div class="avatar-lg placeholder-image"><i class="bi bi-person"></i></div><h3>${role}</h3><p>Official placeholder designation.</p></article>`).join("")}</div></section>
      <section class="mb-5"><article class="profile-card large-card" data-aos="fade-up"><div class="profile-img placeholder-image"><i class="bi bi-person-vcard"></i></div><div><span class="section-kicker">Officer Message</span><h2>Message from Revenue Officer</h2><h3>Mr. Example Ahmed</h3><p>Our department remains committed to clear guidance, respectful public dealing, and timely support for citizens seeking revenue-related services in District Central Karachi.</p><a class="btn btn-primary-gradient" href="#">Read More</a></div></article></section>
      <section id="downloads" class="mb-5"><div class="section-heading text-start"><span class="section-kicker">Resources</span><h2>Downloads</h2></div><div class="download-grid">${downloads.map((item) => `<a class="download-card" href="#"><i class="bi bi-file-earmark-pdf"></i><strong>${item}</strong><span>Public information PDF</span></a>`).join("")}</div></section>
      <section id="faq" class="mb-5"><div class="section-heading text-start"><span class="section-kicker">Citizen Support</span><h2>Frequently Asked Questions</h2></div>${revenueFaq()}</section>
      <section class="mb-5"><div class="section-heading text-start"><span class="section-kicker">Related Departments</span><h2>Related Departments</h2></div><div class="row g-4">${[["bi-cash-stack","Accounts"],["bi-scale","Judicial"],["bi-building","General"],["bi-file-earmark-person","Domicile"]].map(([icon, name]) => `<div class="col-md-6 col-xl-3"><article class="dept-card h-100"><i class="bi ${icon}"></i><h3>${name}</h3><p>Related branch coordination and public support.</p><a href="branches.html">View Department</a></article></div>`).join("")}</div></section>
    </div></div></div></section>
    <section class="complaint-cta" id="contact-cta"><div class="container"><div class="cta-panel" data-aos="zoom-in"><div><span class="section-kicker">Need Assistance?</span><h2>Need Help?</h2><p>If you require assistance regarding Revenue services, our team is here to help.</p></div><div class="cta-actions"><a class="btn btn-primary-gradient" href="#contact-card">Contact Revenue Department</a><a class="btn btn-outline-primary" href="#">Submit Complaint</a></div></div></div></section>
    <section class="section pt-0" id="contact-card"><div class="container"><article class="contact-card" data-aos="fade-up"><span class="section-kicker">Contact</span><h2>Revenue Department Office</h2><p><strong>Address:</strong> District Central Office, Karachi, Sindh</p><p><strong>Phone:</strong> 021-00000000</p><p><strong>Email:</strong> revenue@example.gov.pk</p></article></div></section>
  </main>${siteFooter()}`;
}
